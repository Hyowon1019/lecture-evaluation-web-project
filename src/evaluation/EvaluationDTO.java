...
public class EvaluationDTO {
    ...
    public int getEvaluaionID() {
        return evaluaionID;
    }
    public void setEvaluaionID(int evaluaionID) {
        this.evaluaionID = evaluaionID;
    }
    ...
    public EvaluationDTO(int evaluaionID, String userID, String lectureName, String professorName, int lectureYear,
